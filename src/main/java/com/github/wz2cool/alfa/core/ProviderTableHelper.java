package com.github.wz2cool.alfa.core;

import com.github.wz2cool.alfa.annotation.View;
...
public final class ProviderTableHelper {
    ...
    private static ProviderTable initProviderTable(Class<?> entityClass) {
        ...
        for (Field declaredField : declaredFields) {
            ...
            final String dbColumn = ProviderTableHelper.underline(declaredField.getName());
            if (column == null) {
                builder.withDbColumn(dbColumn)
                        .withDbColumnTable(null)
                        .withDbInsertColumn(dbColumn);
                ;
            } else {
                String name = StringUtils.defaultIfEmpty(column.name(), dbColumn);
                ...
                builder.withDbInsertColumn(name);
            }
        ...
        final String tableName = StringUtils.defaultIfEmpty(Optional.ofNullable(entityClass.getAnnotation(View.class))
                .map(View::value).orElse(null), defaultTableName);
